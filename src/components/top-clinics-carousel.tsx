      ...
      >
        {clinics.map((clinic) => {
          ...
          return (
            <article
              key={clinic.id}
              className="min-w-[320px] max-w-[320px] snap-start overflow-hidden rounded-[28px] border border-border bg-white shadow-[0_12px_28px_rgba(0,0,0,0.1)] transition-transform duration-200 hover:-translate-y-1 sm:min-w-[360px] sm:max-w-[360px]"
            >
